...
NEURON {
	...
	RANGE gnabar, gkbar, vtraub, vtraub2, i_rec
...
PARAMETER {
	gnabar= 1.0e-1 	(S/cm2)  : Destexhe et al., 1998; 1.0e-2 Amarillo et al., 2014
	gkbar= 1.0e-1 	(S/cm2)  :       "		; 2.0e-3 Amarillo et al., 2014
